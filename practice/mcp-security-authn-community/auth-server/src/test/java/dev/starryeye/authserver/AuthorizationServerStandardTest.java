...
class AuthorizationServerStandardTest {
    ...
    static final String CLIENT_ID = "shop-agent";
    static final String CLIENT_SECRET = "shop-agent-secret";
    static final String ISSUER = "http://localhost:9000";
    static final String REDIRECT_URI = "http://localhost:8100/login/oauth2/code/authserver";
